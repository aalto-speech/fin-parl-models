...
for testset in parl-test-seen parl-test-unseen parl2021-test lp-test speecon-test yle-test-new; do
...
for am in exp/i/tri4j exp/chain/tdnn_blstm_a_multigpu exp/chain/tdnn_d exp/andre_comparison/chain/tdnn_d exp/combined_comparison/chain/tdnn_d; do
